...
public class DocumentRepoTest {
    ...
    public void getAllRecords_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/document/viewAllDocuments").contentType(MediaType.APPLICATION_JSON))
    ...
    public void getDocumentById() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/document/viewDocument/1").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andDo(result -> {
                    System.out.println(records);
                });
